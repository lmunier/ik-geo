...
DH_Params = []
DH_Params.append(["r", 0, 0.089159, pi / 2])
DH_Params.append(["r", -0.425, 0, 0])
DH_Params.append(["r", -0.39225, 1.50, 0])
DH_Params.append(["r", 0, 0.10915, pi / 2])
DH_Params.append(["r", 0, 0.09465, -pi / 2])
DH_Params.append(["r", 0, 0.0823, 0])
