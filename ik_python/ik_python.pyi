...
class KinematicsObject:
    ...
    """
    def __init__(self, hMatrix: Annotated[NDArray[np.generic], Literal[6, 3]] | Annotated[List[List[float]], [6,3]], 
                 pMatrix: Annotated[NDArray[np.generic], Literal[7, 3]] | Annotated[List[List[float]], [7,3]]) -> None:
        ...
...
class Robot:
    ...
    """
    def __init__(self, robotType: Literal["Irb6640"] | Literal["KukaR800FixedQ3"] | Literal["Ur5"] | Literal["ThreeParallelBot"]
                 | Literal["TwoParallelBot"] | Literal["RrcFixedQ6"] | Literal["SphericalBot"] | Literal["YumiFixedQ3"] 
                 | Literal["SphericalTwoParallel"] | Literal["SphericalTwoIntersecting"] | Literal["Spherical"] | Literal["ThreeParallelTwoIntersecting"] 
                 | Literal["ThreeParallel"] | Literal["TwoParallel"] | Literal["TwoIntersecting"] | Literal["GenSixDof"] ) -> None:
        ...
    ...
    def get_ik(self, rotationMatrix: Annotated[NDArray[np.generic], Literal[3, 3]] | Annotated[List[List[float]], [3, 3]], 
               positionVector: Annotated[NDArray[np.generic], Literal[3]] | Annotated[List[float], [3]]) -> Tuple[List[float], bool]:
        """
    ...
    def forward_kinematics(self, qVals : Annotated[List[float], [6]] | Annotated[NDArray[np.generic], Literal[6]]) -> Tuple[List[List[float]], List[float]]:
        """
